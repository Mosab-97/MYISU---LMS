/*
  # Fix Users Table RLS Policies and Role Constraints

  1. Security Fixes
    - Remove recursive policy causing infinite recursion
    - Add safe policy for professors to read enrolled students
    - Fix role constraint to allow 'student' and 'professor'

  2. Data Integrity
    - Ensure proper role validation
    - Fix academic year constraints
*/
